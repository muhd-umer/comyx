...
environment = {
    ...
    "pathloss": {
        "center": {"type": "free-space", "alpha": 3, "p0": 25},  # Center users
        "ris": {"type": "free-space", "alpha": 3, "p0": 25},  # BS to RIS
        "risC": {"type": "free-space", "alpha": 2.7, "p0": 25},  # RIS to center users
        "risE": {"type": "free-space", "alpha": 2.3, "p0": 25},  # RIS to edge user
        "edge": {"type": "free-space", "alpha": 3.5, "p0": 25},  # Edge users
        "inter": {"type": "free-space", "alpha": 3.5, "p0": 25},  # Interference links
    },
}
...
constants = {
    ...
    "SIGMA": 4.96,  # Shadowing standard deviation in dB
}
